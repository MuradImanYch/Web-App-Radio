...
const page = async ({ searchParams }) => {
  ...
  return (
    <div className='search'>
      <h1>Searching by: {name && 'Name - ' + name} {country && 'Country - ' + country} {language && 'Language - ' + language} {tag && 'Tag - ' + tag} {strict && 'Strict - ' + strict} | Search results ({searchResults.length})</h1>
