...
export const generateMetadata = ({ searchParams }) => {
  ...
  return {
    ...
    title: {
      default: langJSON.translations.en.metaTitleSearch.replace('{{query}}', queryFormatted),
      template: '%s | Legendary Radio',
    },
    description: langJSON.translations.en.metaDescSearch.replace('{{query}}', queryFormatted),
    ...
    openGraph: {
      title: langJSON.translations.en.metaTitleSearch.replace('{{query}}', queryFormatted),
      description: langJSON.translations.en.metaOGDescSearch.replace('{{query}}', queryFormatted),
      url: `/search?${queryStr}`,
